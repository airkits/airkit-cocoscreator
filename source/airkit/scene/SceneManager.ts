...
namespace airkit {
    ...
    export class SceneManager {
         ...
         * @param cls
         */
        public static registerScene(scene_type: number, name: string, cls: any): any {
        ...
        private registerEvent(): void {
            EventCenter.addEventListener(EventID.CHANGE_SCENE, this, this.onChangeScene)
            Laya.stage.on(Laya.Event.RESIZE, this, this.resize)
        }
        private unRegisterEvent(): void {
            EventCenter.removeEventListener(EventID.CHANGE_SCENE, this, this.onChangeScene)
            Laya.stage.off(Laya.Event.RESIZE, this, this.resize)
        }

        private resize(e: Laya.Event): void {
            Log.info("SceneManager Receive Resize {0} {1}", Laya.stage.width, Laya.stage.height)
