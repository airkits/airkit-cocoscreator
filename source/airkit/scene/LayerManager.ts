...
namespace airkit {
  ...
  export class LayerManager extends Singleton {
    ...
    public static resize(e: Laya.Event): void {
      Log.info(
      ...
      // obj.displayObject.graphics.clear()
      // obj.displayObject.graphics.drawRect(0, 0, obj.width, obj.height, "#33333333")
    }
