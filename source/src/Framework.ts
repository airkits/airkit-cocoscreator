...
namespace airkit {
    ...
    export class Framework extends Singleton {
         ...
         */
        public setup(root: fgui.GComponent, log_level: LogLevel = LogLevel.INFO, design_width: number = 750, design_height: number = 1334, screen_mode: string = '', frame: number = 1): void {
