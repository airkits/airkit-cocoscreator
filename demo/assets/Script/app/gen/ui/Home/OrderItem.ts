...
export default class OrderItem extends airkit.BaseView {
	...
	public static createInstance():OrderItem {
		return <OrderItem>(fgui.UIPackage.createObject("Home", "OrderItem"));
	}
